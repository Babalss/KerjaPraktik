...
<div class="container mt-4">
  <h2 class="h4 fw-bold text-primary mb-3">Tambah Post</h2>
  ...
  <form action="{{ route('admin.blog.posts.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" id="slug" class="form-control bg-light"
             value="" placeholder="akan terisi otomatis" readonly>
    </div>
    ...
    {{-- Gambar Hero --}}
    <div class="mb-3">
      <label class="form-label">Gambar Hero (jpg/png, maks 2MB)</label>
