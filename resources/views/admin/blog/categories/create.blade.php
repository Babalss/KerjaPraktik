...
<div class="container mt-4">
  <h2 class="mb-3">Tambah Kategori Blog</h2>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Jika user mengetik di field slug, jangan auto-override lagi
  let slugDirty = slugEl.value.trim().length > 0;
  slugEl.addEventListener('input', () => { slugDirty = slugEl.value.trim().length > 0; });
